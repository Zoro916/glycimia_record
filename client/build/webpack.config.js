...
alias = Object.assign(alias, pickFiles({
  id: /(reducers\/[^\/]+).(js)/,
  pattern: SRC_PATH + '/store/reducers/*'
}));
...
alias = Object.assign(alias, pickFiles({
  id: /(actions\/[^\/]+).(js)/,
  pattern: SRC_PATH + '/store/actions/*'
}));

// global
alias = Object.assign(alias, pickFiles({
  id: /(global\/.+).(js|jsx|less|css)$/,
  pattern: SRC_PATH + '/global/**'
}));

// components
// import Alert from 'components/alert';
alias = Object.assign(alias, pickFiles({
  id: /(components\/.+).(js|jsx|less)$/,
  pattern: SRC_PATH + '/components/**'
}));

//pages
alias = Object.assign(alias, pickFiles({
  id: /(pages\/.+).(js|jsx|less)$/,
  pattern: SRC_PATH + '/pages/**'
}));
...
config.module.loaders.push({
  ...
  loaders: [
    'url?limit=8000&name=img/[hash:8].[ext]',
    'image-webpack'
  ]
});
